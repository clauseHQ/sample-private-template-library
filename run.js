 ...
 * GLOBALS
 */
const LIBRARY_OWNER = 'Clause Inc.';
const LIBRARY_OWNER_LOGO = 'accord_logo.png';
const LIBRARY_OWNER_WEBSITE = 'https://clause.io';
...
(async function () {
    try {
        ...
        if(!process.env.SKIP_GENERATION) {
            ...
            await fs.copy(LIBRARY_OWNER_LOGO, './build/'+LIBRARY_OWNER_LOGO);
